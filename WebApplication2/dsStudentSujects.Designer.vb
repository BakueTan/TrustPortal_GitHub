...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("dsStudentSujects"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class dsStudentSujects
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As dsStudentSujects = CType(MyBase.Clone,dsStudentSujects)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsStudentSujects"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsStudentSujects.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As dsStudentSujects = New dsStudentSujects()
    ...
    Partial Public Class studentsubjectsDataTable
        ...
        Public Overloads Function AddstudentsubjectsRow( _
                    ...
                    ByVal Intake As String) As studentsubjectsRow
            Dim rowstudentsubjectsRow As studentsubjectsRow = CType(Me.NewRow,studentsubjectsRow)
            Dim columnValuesArray() As Object = New Object() {StudentID, SubjectID, Year, Program, Semester, StudentSurname, Subject, Description, YearEnrolled, Forms, Gender, Session, StudentName, DateEnrolled, DateOfBirth, ResidentialAdress, ContactNumber, EmailAddress, Address2, Address3, NationalID, LoggedUser, Type, Intake}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function FindByStudentIDSubjectIDYearProgramSemester(ByVal StudentID As String, ByVal SubjectID As String, ByVal Year As Integer, ByVal Program As String, ByVal Semester As Integer) As studentsubjectsRow
            Return CType(Me.Rows.Find(New Object() {StudentID, SubjectID, Year, Program, Semester}),studentsubjectsRow)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() {Me.columnStudentID, Me.columnSubjectID, Me.columnYear, Me.columnProgram, Me.columnSemester}, true))
...
Namespace dsStudentSujectsTableAdapters
    ...
    Partial Public Class studentsubjectsTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        studentsubjects.StudentID, studentsubjects.Year, studentsubjects.Se"& _ 
                "mester, studentsubjects.SubjectID, StudentPersonalDetails.StudentSurname, Subjec"& _ 
                "ts.Subject, studentsubjects.Program, forms.Description, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      "& _ 
                "   enrollment.YearEnrolled, forms.Forms, enrollment.Gender, enrollment.Session, "& _ 
                "StudentPersonalDetails.StudentName, enrollment.DateEnrolled, StudentPersonalDeta"& _ 
                "ils.DateOfBirth, StudentPersonalDetails.ResidentialAdress, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                   "& _ 
                "      StudentPersonalDetails.ContactNumber, StudentPersonalDetails.EmailAddress,"& _ 
                " StudentPersonalDetails.Address2, StudentPersonalDetails.Address3, StudentPerson"& _ 
                "alDetails.NationalID, @user AS LoggedUser, Subjects.Type, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                    "& _ 
                "     enrollment.Intake"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            studentsubjects INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"            "& _ 
                "             StudentPersonalDetails ON studentsubjects.StudentID = StudentPerson"& _ 
                "alDetails.StudentID INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Subjects ON studentsubj"& _ 
                "ects.SubjectID = Subjects.SubjectID INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         forms O"& _ 
                "N studentsubjects.Program = forms.Forms INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         enr"& _ 
                "ollment ON studentsubjects.StudentID = enrollment.StudentID AND studentsubjects."& _ 
                "Program = enrollment.Program AND studentsubjects.Year = enrollment.Year AND stud"& _ 
                "entsubjects.Semester = enrollment.Semester"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (studentsubjects.Year ="& _ 
                " @level) AND (studentsubjects.Semester = @sem) AND (studentsubjects.Program = @p"& _ 
                "rog) AND (studentsubjects.StudentID = @stud) AND (studentsubjects.RegStatus = 'R"& _ 
                "egistered')"
            ...
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@level", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "Year", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@sem", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "Semester", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As dsStudentSujects.studentsubjectsDataTable, ByVal user As String, ByVal level As Integer, ByVal sem As Integer, ByVal prog As String, ByVal stud As String) As Integer
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(4).Value = CType(stud,String)
            End If
        ...
        Public Overloads Overridable Function GetData(ByVal user As String, ByVal level As Integer, ByVal sem As Integer, ByVal prog As String, ByVal stud As String) As dsStudentSujects.studentsubjectsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (user Is Nothing) Then
                Throw New Global.System.ArgumentNullException("user")
            Else
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(4).Value = CType(stud,String)
            End If
            Dim dataTable As dsStudentSujects.studentsubjectsDataTable = New dsStudentSujects.studentsubjectsDataTable()
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As dsStudentSujects, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As dsStudentSujects, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            Return result
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As dsStudentSujects, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            Return result
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As dsStudentSujects) As Integer
