<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/Master1.Master" CodeBehind="StudentReport.aspx.vb"  Inherits ="TrustAcademyPortal.StudentReport" 
    title="StudentPortal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <rsweb:reportviewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        ...
        WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="564px" 
        SizeToReportContent="True" Width="686px" style="margin-right: 0px" 
